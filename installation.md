...
For installing clij2 and the clij2-assistant, [please follow the instructions on the clij website](https://clij.github.io/clij2-docs/installationInFiji).
...
and enter its location under `Plugins > ImageJ on GPU (CLIJ2-Assistant) > Options > Build and Run options`.
